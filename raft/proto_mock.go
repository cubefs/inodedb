...
func (m *MockAddressResolver) Resolve(nodeID uint64) (Addr, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Resolve", nodeID)
	ret0, _ := ret[0].(Addr)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAddressResolverMockRecorder) Resolve(nodeID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Resolve", reflect.TypeOf((*MockAddressResolver)(nil).Resolve), nodeID)
}
