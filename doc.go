...
* Collections, Shards, Items, Links

* Item, ino --> fields, ino is generated by the system, and items are partitioned into 'shards' by ino ranges. An item can be represented as a JSON document.

* Shard, the physical 'container' of items, working as the replication and storage unit.

* Collection, the logical 'type' of items. While InodeDB is schemaless by design, all items of a collection typically have a similar structure (although they can have different fields) and work for the same application.
